  ...
  return (
    <Section id='fees' className='gap-2'>
      ...
      <p className='text-red-500'>
        NOTE: In order to have taken advantage of the early registration fee, the payment must have
        been received by May 31st, of the current year
      </p>
      <p>
        New applicants, interested to join, please submit your name to our waiting list. for this
        season's membership, in the event that membership spaces open up.
      </p>
      <p className='text-xl'>Registration Site</p>
      <p>
        All previous year members who apply before the season start date have priority placing on
        the membership list, any new members will be placed in the order they contacted the club.
        All others will be placed on a waiting list and contacted if any spots open up.
      </p>
